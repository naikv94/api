...
from apps.common.views import CompanyListView,ContactDeleteView, ContactListView,ContactUpdateView,CompanyUpdateView, HomeView, SignUpView, DashboardView, ProfileUpdateView, ProfileView, CompanyDeleteView
...
urlpatterns = [
    ...
    path('companyUpdate/<int:pk>/',CompanyUpdateView.as_view(), name='companyUpdate'),
    path('companyDelete/<int:pk>/',CompanyDeleteView.as_view(), name='companyDelete'),
